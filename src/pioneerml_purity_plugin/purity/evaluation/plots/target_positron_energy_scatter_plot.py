...
@PLOT_REGISTRY_DEF.register("purity_positron_energy_scatter")
class PurityPositronEnergyScatterPlot(BasePlot):
    name = "purity_positron_energy_scatter"
    ...
    def render(
        ...
        *,
        ...
        max_batches: int = 200,
        title: str = "Positron Energy (raw units): Truth vs Pred",
