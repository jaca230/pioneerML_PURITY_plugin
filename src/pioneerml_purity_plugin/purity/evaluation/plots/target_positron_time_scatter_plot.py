...
@PLOT_REGISTRY_DEF.register("purity_positron_time_scatter")
class PurityPositronTimeScatterPlot(BasePlot):
    name = "purity_positron_time_scatter"
    ...
    def render(
        ...
        *,
        ...
        max_batches: int = 200,
        title: str = "Positron Time: Proxy Truth vs Pred",
        ...
        ax.set_xlabel("truth time proxy")
