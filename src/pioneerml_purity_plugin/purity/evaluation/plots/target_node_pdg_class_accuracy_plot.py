...
@PLOT_REGISTRY_DEF.register("purity_node_pdg_class_accuracy")
class PurityNodePDGClassAccuracyPlot(BasePlot):
    name = "purity_node_pdg_class_accuracy"
    ...
    def render(
        ...
        *,
        ...
        max_batches: int = 200,
        title: str = "Node PDG Confusion Matrix",
        ...
        if not diag:
            return None
        conf = np.asarray(diag.get("node_conf"), dtype=np.int64)
        if conf.shape != (3, 3):
            return None
